...
print(f"Escribiendo parquet en: {ruta_completa} (particionado por año/mes/dia)")

df_cmstfl.coalesce(numero_particiones).write.partitionBy("año", "mes", "dia").mode("overwrite").parquet(ruta_completa)
